...
symbolFlag( FLAG_ARG_THIS, npr, "this", "the hidden object argument")
...
symbolFlag( FLAG_FUNCTION_THIS, npr, "function invoke" , "proxy for first-class function invocation" )
...
symbolFlag( FLAG_NO_DEFAULT_USE , ypr, "no use ChapelStandard" , "Do not implicitly use ChapelStandard" )
